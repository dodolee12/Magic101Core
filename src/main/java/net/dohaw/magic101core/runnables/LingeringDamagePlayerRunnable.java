...
public class LingeringDamagePlayerRunnable extends BukkitRunnable {
    ...
    public LingeringDamagePlayerRunnable(Player attacked, Profile attackedProfile, int lingeringDamage){
